      ...
      <div class="login-container">
        <div class="login-form-wrapper" @keyup.enter="login">
          ...
          <el-form class="login-form" ref="form" :model="form" label-width="60px">
            <el-form-item label="账号" class="el-input--xlarge"> 
            ...
            <el-row>
              ...
              <el-col :span="10">
                <el-form-item>
                  <el-button class="login-form-submit" type="primary" @click="login" :disabled="buttonDisabled">登录</el-button>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
.logo-wrapper
  padding: 30px
  border-radius: 10px
  background: linear-gradient(to right, #e9e3ff 0%,#e2fefe 100%)
.logo
  text-align: center
.login-form
