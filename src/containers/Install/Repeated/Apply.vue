...
export default {
  ...
  data () {
    const menu = getMenus().find(item => item.menuurl === '/install/repeated/apply')
    return {
      ...
      tableInitList: ['clientNo', 'clientName', 'clientAddress', 'cardNo', 'clientPhone', 'clientContact'],
      tableFullList: ['clientNo', 'clientName', 'clientAddress', 'cardNo', 'clientPhone', 'clientContact', 'userCount', 'clientType', 'serviceType'],
      columns: {
        orderCode: {
          label: '报装编号',
          sort: true,
